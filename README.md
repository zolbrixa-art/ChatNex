...
🌟 Key Features
Multi-Engine AI Selector: Switch between local Ollama models and cloud gateways (GPT, Gemma, Gemini) seamlessly.
Temperature Control Slider: Fine-tune AI response creativity from 0.0 (focused/analytical) to 2.0 (creative/unique).
...
Interactive Community Feedback Pipeline: Dynamic submission form and admin-synchronized feedback review interface powered by client-side persistence and a unified design system.
📁 Project Structure
ChatNex/
├── static/
